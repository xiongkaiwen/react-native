...
export default class UserEdit extends Component{
	...
	getData(){
		let that = this;
		let url = Utils.domain+'app/sharerorders/getById';
		let postData = {
		...
		return(
			<View style={[styles.contrainer,styles.flex_1]}>
				...
				<ScrollView style={styles.main}>
					...
					{/*订单下的商品*/}
		      		...
		      		<View style={styles.order_info}>
						<View style={[styles.row,styles.item]}>
							<Text style={[styles.c13_666]}>购买者：{orderDetail.loginName}</Text>
						</View>
		      			{/* 订单编号 */}
		      			<View style={[styles.row,styles.item]}>
					...
					<View style={[styles.order_info,{marginTop:10}]}>
						<View style={[styles.item,styles.row]}>
							<Text style={[styles.c13_666]}>可获得积分：</Text>
							<Text style={[styles.c13_666,styles.red]}>{orderDetail.shareScore}</Text>
						</View>
						<View style={[styles.item,styles.row]}>
							<Text style={[styles.c13_666]}>可获得佣金：</Text>
							<Text style={[styles.c13_666,styles.red]}>￥{orderDetail.shareMoney}</Text>
						</View>
					</View>
