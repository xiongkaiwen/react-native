	...
	render(){
		...
		return(
			<View style={[styles.header, styles.row, styles.center]}>
				...
				<TouchableOpacity style={[styles.right,styles.center]} onPress={this.goShopCat}>
						<Image source={require('./img/news_more.png')} resizeMode={'cover'} style={{width:21,height:5.25,marginTop:3.5}} />
				</TouchableOpacity>
